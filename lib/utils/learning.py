...
from MAMP.model_mamp.transformer import Transformer
...
def load_backbone(args):
    ...
    if args.backbone=='DSTformer':
        ...
        model_backbone = DSTformer(dim_in=3136, dim_out=3136, dim_feat=args.dim_feat, dim_rep=args.dim_rep, 
        ...
        model_backbone = Transformer(dim_in=3136, dim_feat=256, decoder_dim_feat=256,
